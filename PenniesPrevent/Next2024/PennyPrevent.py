...
if etapa == 3:
  ...
  f"Predição em tempo real: '{list(outputStr2Int.keys())[dados_classe_predita]}'" # se 2 valores do dicionário são iguais, mostra o primeiro
  ...
  if valores_teste != '':
    try:
      ...
      f"Predição do teste: '{list(outputStr2Int.keys())[classe_predita]}'" # se 2 valores do dicionário são iguais, mostra o primeiro
      ...
      # Make prediction
      # estado_predito = modelo_salvo.predict(guess_reshape) # mostra as probabilidades de cada classe

      # f'{estado_predito}' # debug (retirar no final)
      ...
      f'Predição do modelo salvo: "{list(outputStr2Int.keys())[classe_predita]}"' # se 2 valores do dicionário são iguais, mostra o primeiro
