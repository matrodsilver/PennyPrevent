...
pp = "E:/PennyPreventV5.1/Fotos/PennyPreventLogo-removebg-preview.png" # mudar caminho

# mudando estilo da página
sl.set_page_config(layout="wide")
tab1, tab2, tab3 = sl.tabs(["Penny Prevent", "Dados", "Equipe"])
...
with tab2:
    tab4, tab5 = sl.tabs(["Dashboard", "IA"])
  ...
  sl.markdown('''
    <div style= "display: flex; justify-content: center; align-items: center;">     
        <div class="card border-0" style="height: 20rem; width: 25rem; background-color: #00007d; display: flex; justify-content: center; align-items: center;">
            <img style="max-height: 20rem; max-width: 25rem;" class="card-img-top" pp alt="Logo Penny Prevent">
        </div>
